...
addBlockDetection(
  ...
  "@regex delete flags [gi] of @regex []::regex boolean",
)
...
test("block detection functionality", () => {
  ...
  console.log("\n=== summary ===")
  console.log(
    '✓ "array builder (current) {}" → "array builder (current::square arrays) {}::arrays square"',
  )
  console.log(
    '✓ "delete flags [gi] of regex []" → "@regex delete flags [gi] of @regex []::regex boolean"',
  )
